...
import static com.gdj.camera.JCameraView.BUTTON_STATE_BOTH;
import static com.gdj.camera.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.gdj.camera.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
//    private boolean hasWindowFocus = true;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (state == STATE_PRESS_LONG_CLICK) {
            ...
            canvas.drawArc(rectF, -90, progress, false, mPaint);//progress   0 ~ 362
        }
    }
