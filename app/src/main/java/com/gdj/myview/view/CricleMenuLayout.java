 ...
 */
public class CricleMenuLayout extends ViewGroup {
    private int mRadius;
    /**
     * 该容器内child item的默认尺寸
     */
    ...
    private int mMenuItemLayoutId = R.layout.item_circle_menu;//单个按钮布局

    public CricleMenuLayout(Context context, AttributeSet attrs)
