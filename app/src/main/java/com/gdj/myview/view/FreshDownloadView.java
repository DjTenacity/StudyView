...
public class FreshDownloadView extends View {
    ...
    public FreshDownloadView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        circular_edge = getResources().getDimension(R.dimen.dp_10);
    ...
    private void parseAttrs(TypedArray array) {
        if (array != null) {
            try {
                setRadius(array.getDimension(R.styleable.FreshDownloadView_circular_radius, getResources().getDimension(R.dimen. dp_80)));
                ...
                setCircularWidth(array.getDimension(R.styleable.FreshDownloadView_circular_width, getResources().getDimension(R.dimen.dp_4)));
                setProgressTextSize(array.getDimension(R.styleable.FreshDownloadView_progress_text_size2, getResources().getDimension(R.dimen.default_text_size )));
            } finally {
                array.recycle();
            }
        }
