...
public class AgreeView extends View implements View.OnClickListener {
    ...
    //默认点赞图片
    private static final int DEFAULT_IMG = R.mipmap.ic_launcher_round;
    //动画 文字
    ...
    private void initView(AttributeSet attrs) {
        if (attrs != null) {
            ...
            if (agreeDrawable == null) {
                agreeDrawable = ContextCompat.getDrawable(getContext(), DEFAULT_IMG);
            }
            //资源释放
            typedArray.recycle();
        }
    ...
    public void onClick(View v) {
        Log.e("setPopAnimationtext",(mPopupWindow==null)+text+(mPopupWindow.isShowing()));
    ...
    private void setPopAnimation() {
        Log.e("setPopAnimationtext",text);
